(custom-set-variables
 ...
 '(atom-api:feed/seed-urls '("http://blog.flyoverblues.com/atom"))
 ...
 '(clojure-build-tool-files
   '("build.boot" "build.gradle" "build.gradle.kts" "deps.edn" "shadow-cljs.edn"))
 '(clojure-defun-indents '(fact facts future-fact future-facts variant fdef))
...
\"###########.######\" };") t)
 '(helm-mode t)
 '(highlight-changes-colors '("#D700D7" "#AF87FF"))
