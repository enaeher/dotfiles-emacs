...
\"###########.######\" };")))
 ...
 '(projectile-project-root-files-bottom-up (quote ("project.clj" ".projectile" ".git" ".hg" ".fslckout" ".bzr" "_darcs")))
