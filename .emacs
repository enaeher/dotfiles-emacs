...
\"###########.######\" };")) t)
 ...
 '(package-selected-packages
   (quote
    (counsel-projectile ivy     (counsel-projectile ivy-projectile ibuffer-vc forge clj-refactor cider json-navigator hl-sentence 0blayout csv-mode wordnut flycheck-joker ws-butler restclient-helm burdock-mode evil multi-web-mode ethan-wspace yard-mode yaml-mode web-mode use-package undo-tree tern tagedit sublime-themes subatomic256-theme soothe-theme solarized-theme slime rspec-mode rinari rich-minority rainbow-delimiters pivotal-tracker pbcopy org-present names moe-theme markdown-mode json-reformat js2-mode ido-vertical-mode ibuffer-tramp hl-sexp hideshowvis helm-mu hc-zenburn-theme gruber-darker-theme git-timemachine flycheck-pos-tip flycheck-color-mode-line flx-ido f elisp-slime-nav distinguished-theme crosshairs company-go company-emoji color-theme-sanityinc-tomorrow cider-profile cider-decompile chruby busybee-theme bubbleberry-theme birds-of-paradise-plus-theme beacon base16-theme auto-complete auctex anti-zenburn-theme ample-theme aggressive-indent ag afternoon-theme)))-projectile ibuffer-vc forge clj-refactor cider json-navigator hl-sentence 0blayout csv-mode wordnut flycheck-joker ws-butler restclient-helm burdock-mode evil multi-web-mode ethan-wspace yard-mode yaml-mode web-mode use-package undo-tree tern tagedit sublime-themes subatomic256-theme soothe-theme solarized-theme slime rspec-mode rinari rich-minority rainbow-delimiters pivotal-tracker pbcopy org-present names moe-theme markdown-mode json-reformat js2-mode ido-vertical-mode ibuffer-tramp hl-sexp hideshowvis helm-mu hc-zenburn-theme gruber-darker-theme git-timemachine flycheck-pos-tip flycheck-color-mode-line flx-ido f elisp-slime-nav distinguished-theme crosshairs company-go company-emoji color-theme-sanityinc-tomorrow cider-profile cider-decompile chruby busybee-theme bubbleberry-theme birds-of-paradise-plus-theme beacon base16-theme auto-complete auctex anti-zenburn-theme ample-theme aggressive-indent ag afternoon-theme)))
